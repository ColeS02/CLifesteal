...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(CLifesteal.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            CLifesteal.getInstance().getLogger().info("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            CLifesteal.getInstance().getLogger().warning("Using default as I failed to load: " + file);
            ...
            CLifesteal.getInstance().getLogger().warning("Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            CLifesteal.getInstance().getLogger().warning(ex.getMessage());
        }
